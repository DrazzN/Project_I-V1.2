                ...
                <content>
                    <div class="d-sm-flex py-5 align-items-center justify-content-between">
                        <div>
                            ...
                            ?>
                            <button class="btn btn-primary btn-lg"><a href="<?php echo base_url; ?>students/register.php" class="text-light">Start The Enrollment</a></button>
                        </div>
        ...
        <div class="d-flex pt-3">
            <div class="col-2 p-0">
                <ul class="nav flex-column">
                    ...
                    <li class="nav-item"><a href="portal.php" style="text-decoration: none;">Sign In</a></li>
                    <li class="nav-item"><a href="<?php echo base_url; ?>students/register.php" style="text-decoration: none;">Register</a></li>
                </ul>
            </div>
            <div class="col-2 p-0">
                <ul class="nav flex-column">
