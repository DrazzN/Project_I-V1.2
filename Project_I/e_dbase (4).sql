...
--
-- Table structure for table `assgninfo`
--

CREATE TABLE `assgninfo` (
  `id` int(11) NOT NULL,
  `assignment_id` varchar(11) NOT NULL,
  `floc` varchar(100) NOT NULL,
  `datesub` varchar(50) NOT NULL,
  `fdesc` varchar(100) NOT NULL,
  `subject_code` varchar(11) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;

--
-- Dumping data for table `assgninfo`
--

INSERT INTO `assgninfo` (`id`, `assignment_id`, `floc`, `datesub`, `fdesc`, `subject_code`) VALUES
(4, '4646', 'uploads/wertgw2022-08-05.jpg', '2022-08-05', 'wfw', 'CACS101');
...
(27, '05-07-2022 04:22:40am', 'IS THIS REAL.', 'admin'),
(28, '30-07-2022 10:32:15pm', 'IS THIS REAL', 'admin'),
(29, '30-07-2022 10:33:05pm', ';;;;;', 'admin');
...
(33, 0, 'uploads/CACS1012022946wert03-08-2022 12:53:39am.png', 'CACS1012022946wert03-08-2022 12:53:39am.png', '03-08-2022 12:53:39am', 'wet', 'CACS101', 2022946);
...
(26, 'cacs', 1011, '1', 'Human Growth and Behavior', '', ''),
(27, 'tesa', 1012, 'first', ' Accounting for Financial Analysis', '', ''),
(28, '123', 123, '123', '123', '', ''),
(29, 'sada ', 1011, 'first', 'Sociology for Social Work', '', ''),
(30, 'ad12', 1012, 'first', 'Business English', '', '');
...
(10, 'das.jpg', 'Hello', 'files/das.jpg', 'CACS101', 'admin', '05-07-2022'),
(11, 'sdf.docx', 'sdfg', 'files/sdf.docx', 'CACS101', 'admin', '02-08-2022');
...
(2023023, 'fast', 'fast@gmail.com', '098f6bcd4621d373cade4e832627b4f6', 'student');
...
--
-- Indexes for table `assgninfo`
--
ALTER TABLE `assgninfo`
  ADD PRIMARY KEY (`id`);
...
--
-- AUTO_INCREMENT for table `assgninfo`
--
ALTER TABLE `assgninfo`
...
--
ALTER TABLE `users`
  MODIFY `user_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2023024;
