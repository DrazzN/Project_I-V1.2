...
if (isset($_GET['deletemsg'])) {
  $objdmsg->delMessage($_GET['message'], $_GET['sent_by'], $_GET['date_sent']);
  header("location: index.php");
}
?>
<!DOCTYPE html>
        ...
        <div class="card card-outline card-primary" style="height:100%;">
          <div>
            ...
            <main>
              ...
              <div class="wrapper center align-content-center" style="animation-delay: 2s;width:550px">
                <div class="card" id="messageboard" style="padding:10px;">
                  ...
                  <div class="card-body">
                    <div style="overflow-y: scroll;height: 170px;padding-right:10px;font-size:16px;">
                      <?php
                      if (isset($resultmsg)) {
                        foreach ($resultmsg as $row) {
                      ?>
                      <div class="my-1" style="border: 1px solid rgba(0, 0, 0, 0.125);">
                        <div class="px-3" style="border-left:10px solid #666666;">

                          <div class="d-flex">
                            <h3 class="title ellipsis">
                              <?php echo $row['message']; ?>
                            </h3>
                            <div class="summary mx-3 mt-2">
                              <a href="index.php?deletemsg&message=<?php echo $row['message'] . '&sent_by=' . $row['sent_by'] . '&date_sent=' . $row['date_sent'];?>" class="text-danger">delete</a>
                            </div>
                          </div>
                          <div class="d-flex">
                            <div class="subtitle w-50">
                              <span>ID: <i><?php echo $row['sent_by']; ?></i></span>
                            </div>
                            <div class="information w-50 text-center"><i><?php echo $row['date_sent']; ?></i></div>
                          </div>
                        </div>
                      </div>
                      <?php
