...
<div class="modal fade" id="uploadmatModal" tabindex="-1" role="dialog" aria-labelledby="uploadModalLabel" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <form action="<?php echo  base_url ?>admin/course/materials/upload.php" method="POST" enctype="multipart/form-data">
      ...
      foreach ($resultsas as $row) {
        ...
        echo '
              <tr>
                ...
                <td><b>' . $desc . '</b></td>
                <td><b>' . $up_id . '</b></td>
                <td><b><a href="' . base_url . 'admin/course/assignments/' . $floc . '" download>
