<nav class="flex-shrink-0 p-3 bg-light" style="width: 300px;" id="sidebar">
  ...
  <div class="dropdown d-flex">
    <img src="<?php echo base_url ?><?php echo $_SESSION['user'] . '/' . $_SESSION['profile_locate']; ?>" alt="no picture" width="100px" height="100px" class="rounded-circle ms-3">
    <a href="#" class="d-flex align-items-start justify-content-start p-3 link-dark text-decoration-none dropdown-toggle" id="dropdownUser3" data-bs-toggle="dropdown" aria-expanded="false">
      <span class="pt-3"><?php echo $_SESSION["username"]; ?></span>
    </a>
  ...
  <ul class="nav nav-sidebar flex-column nav-flat">
    ...
    <hr>
    <li class="nav-item ho">
      <a href="http://localhost/Project_I/<?php echo $_SESSION['user']; ?>/department/" class="nav-link text-dark<?php if ($page == 'department') { echo 'active'; } ?>">
        <img class="img icon mx-2" src="http://localhost/Project_I/img/library-outline.svg" alt="">Department</a>
    ...
    if (isset($_SESSION['user'])) {
      ...
      <a href="http://localhost/Project_I/' . $_SESSION['user'] . '/setup.php" class="nav-link text-dark';
        ...
        echo '" >
        <img class="img icon mx-2" src="http://localhost/Project_I/img/calendar-outline.svg" alt="">Settings</a>
