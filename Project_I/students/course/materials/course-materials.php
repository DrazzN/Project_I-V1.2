...
<div class="modal fade" id="uploadmatModal" tabindex="-1" role="dialog" aria-labelledby="uploadModalLabel" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <form action="<?php echo  base_url ?>students/course/materials/upload.php" method="POST" enctype="multipart/form-data">
      ...
      foreach ($resultsas as $row) {
        ...
        echo '
              <tr>
                ...
                <td><b>' . $up_id . '</b></td>
                <td>
                <b><a href="' . base_url . 'students/course/assignments/' . $floc . '" download>
                <ion-icon name="download-outline"></ion-icon>Download
                </a>
                <!--<button class="btn-outline-warning btn-shadow-light text-danger" data-toggle="modal" data-target="#uploadModal' . $name . $desc . '" type="submit" name="deleteassign">
