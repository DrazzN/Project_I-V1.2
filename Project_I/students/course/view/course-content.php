  ...
  <section class="d-flex ssize">
    ...
    <content class="w-100">
      <div class="card card-outline" style="height:100%;">
        <div class="d-flex">
          <a href="http://localhost/Project_I/students/course/index.php"><img class="m-3" src="http://localhost/Project_I/img/ico/arrow-back-circle-outline.svg" style="width:30px; height:30px;" alt=""></a>
