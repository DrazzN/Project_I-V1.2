      ...
      <div class="row align-items-center g-lg-5 py-5">
        ...
        <div class="col col-xxl-5 col-md-10 col-sm-10 col-lg-10 mx-auto">
          <form action="http://localhost/Project_I/students/includes/signup.inc.php" method="POST" class="p-4 p-md-5 border rounded-3 bg-light">
            ...
            <div class="form-floating mb-3"> 
              <input type="password" class="form-control" id="floatingPassword" placeholder="Password" name="cpwd" value="<?php //echo $cpassword; ?>" required>
            ...
            <small class="text-muted">
              <p>Have an account ?
              <a class="align-content-start text-mycolorpic" href="http://localhost/Project_I/students/login.php">LogIn Here</a></p>
